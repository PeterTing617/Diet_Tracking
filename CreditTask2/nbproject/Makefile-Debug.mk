...
${OBJECTDIR}/DayMeal.o: DayMeal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DayMeal.o DayMeal.cpp
...
${OBJECTDIR}/MonthBurnt.o: MonthBurnt.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonthBurnt.o MonthBurnt.cpp

${OBJECTDIR}/MonthConsumed.o: MonthConsumed.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonthConsumed.o MonthConsumed.cpp
...
${OBJECTDIR}/NutritionManagement.o: NutritionManagement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NutritionManagement.o NutritionManagement.cpp
...
${TESTDIR}/TestDietTracking.o: TestDietTracking.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestDietTracking.o TestDietTracking.cpp


${TESTDIR}/TestDietTrackingrunner.o: TestDietTrackingrunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestDietTrackingrunner.o TestDietTrackingrunner.cpp


${TESTDIR}/TestExerciseTracking.o: TestExerciseTracking.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestExerciseTracking.o TestExerciseTracking.cpp


${TESTDIR}/TestExerciseTrackingrunner.o: TestExerciseTrackingrunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestExerciseTrackingrunner.o TestExerciseTrackingrunner.cpp


${TESTDIR}/TestNutrition.o: TestNutrition.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestNutrition.o TestNutrition.cpp


${TESTDIR}/TestNutritionrunner.o: TestNutritionrunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestNutritionrunner.o TestNutritionrunner.cpp
...
${OBJECTDIR}/DayMeal_nomain.o: ${OBJECTDIR}/DayMeal.o DayMeal.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DayMeal_nomain.o DayMeal.cpp;\
	else  \
...
${OBJECTDIR}/MonthBurnt_nomain.o: ${OBJECTDIR}/MonthBurnt.o MonthBurnt.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonthBurnt_nomain.o MonthBurnt.cpp;\
	else  \
...
${OBJECTDIR}/MonthConsumed_nomain.o: ${OBJECTDIR}/MonthConsumed.o MonthConsumed.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonthConsumed_nomain.o MonthConsumed.cpp;\
	else  \
...
${OBJECTDIR}/Nutrition_nomain.o: ${OBJECTDIR}/Nutrition.o Nutrition.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Nutrition_nomain.o Nutrition.cpp;\
	else  \
...
${OBJECTDIR}/NutritionManagement_nomain.o: ${OBJECTDIR}/NutritionManagement.o NutritionManagement.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NutritionManagement_nomain.o NutritionManagement.cpp;\
	else  \
